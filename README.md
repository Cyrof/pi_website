...
## URL : https://2e0e-116-87-173-227.ngrok-free.app
# Table of contents
...
After creating the required database and collections, add the following into your .env file by editing the **DATABASE_URL** https://2e0e-116-87-173-227.ngrok-free.app
* Username
* Password
* Cluster Name
* Database Name
